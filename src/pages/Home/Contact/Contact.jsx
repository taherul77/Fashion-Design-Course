          ...
          <Marquee>
            <div className="flex flex-wrap gap-24 justify-center lg:justify-between">
              <svg
                ...
                className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-red-400"
              >
              ...
              <svg
                ...
                viewBox="0 0 32 32"
                aria-label="React"
                className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-blue-400"
              >
                <title>React</title>
              ...
              <div className="">
              <SiTailwindcss className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-blue-400"/>
